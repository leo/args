...
This property exposes all sub arguments that have been parsed by [nanomist](https://npmjs.com/nanomist). This is useful when trying to get the value after the command, for example:
...
| nanomist | Additional parsing options to pass to nanomist, see [nanomist docs](https://github.com/zeit/nanomist) for details | undefined | Object |
