...
exports.handleType = function(value) {
  let type = value;
...
exports.readOption = function(option) {
  ...
  for (const option in args) {
    ...
    if (related) {
      ...
      if (suggestOption.bestMatch.rating >= 0.5) {
        ...
        process.stdout.write(this.generateDetails(suggestion)[0].trim() + '\n');
...
exports.generateExamples = function() {
...
exports.generateDetails = function(kind) {
...
exports.runCommand = function(details, options) {
...
exports.isDefined = function(name, list) {
